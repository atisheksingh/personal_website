          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/atisheksingh/atisheksingh" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                <a href="https://atisheksingh.com" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> </div>
            </header>
            <div className="body">
              <h3>Gas Less layer2 Blockchain </h3>
              <p>The Polygon CDK is a framework that empowers developers to easily create and launch custom layer-2 (L2) blockchains on Ethereum that utilize zero-knowledge proof technology (zkEVMs and optional validium).</p>
              <p> Polygon Chain Development Kit (CDK) is a modular, open-source blockchain stack for developers launching sovereign L2 chains powered by zero-knowledge (ZK) proofs. </p>
            </div>
            <footer> <ul className="tech-list"> <li>Polygon CDK</li> <li>Smart contract</li> <li>postrges</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/atisheksingh/cdk-validium-node" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://qiblockchain.online/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" /></a>
              </div>
            </header>
            <div className="body">
              <h3>QI Blockchain : layer1 blockchain </h3>
              <p>
              QIE Blockchain stands as a cornerstone for Web 3 and DeFi, offering a robust, low-cost network featuring rapid settlement for transaction efficiency.</p>
              </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/atisheksingh/hello-stacks" target="\_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Stacks Bitcoin layer 2 </h3>
              <p>
              Stacks is the leading Bitcoin Layer-2, enabling smart contracts and decentralized applications to use Bitcoin as a secure base layer. Stacks extends the capabilities of Bitcoin without changing Bitcoin, unlocking billions in latent capital. </p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>clarity </li>
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                ...
                <a href="https://github.com/prysmaticlabs/prysm" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Proof of Stake: ETH 2 </h3>
              <p> Prysm, a Golang implementation of the Ethereum Consensus specification, developed by Offchain Labs. See the Changelog for details of the latest releases and upcoming breaking changes.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>GO Lang </li>
                <li>Merge Consensus</li>
                <li>Prysm </li>
                <li>Geth</li>
              </ul>
            </footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/atisheksingh/Chainlink-VRF-tutorials" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://dexwin.bet/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>DEXWin.Bet</h3>
              <p>Smart contact creation for consensus odds from sportsdata.io via chainlink</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>ChainLink</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
              <div className="project-links">
                <a href="https://github.com/atisheksingh/Uniswap-V3-Experiments" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Uniswap v3 clone </h3>
              <p>
              Some scripts to test and experiment with Uniswap v3</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React</li>
